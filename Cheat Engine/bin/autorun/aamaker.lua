...
Authors: SnedS91, MasterGH, ++METHOS
	...
	Many thanks to "cheatengine.org": Dark Byte,  mgr.inz.Player,	++METHOS and all other
	Many thanks to "Gamehacklab[RU]": Xipho,  NullAlex, SER[G]ANT, SnedS91 and all other
